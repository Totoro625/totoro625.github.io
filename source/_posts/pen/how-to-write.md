...
<!-- more -->
![](https://totoro.ink/img/write/Tdhv.jpg)

本次演讲的主题是：X 型文案和 Y 型文案，如何减少文案中的“自嗨现象”，写真正用户导向的互联网文案。

# 一、X 型文案 VS Y 型文案

![](https://totoro.ink/img/write/TWdO.jpg)
...
![](https://totoro.ink/img/write/TbxC.jpg)

其中有一些人的写法是这样的，而这就是我所说的 X 型文案。

![有一种文案，只是自己的A片](https://totoro.ink/img/write/THKM.jpg)
...
![有一种文案，只是自己的A片](
https://totoro.ink/img/write/TFjU.jpg)

但是还有另外完全不同的写法，我们称之为“Y 型文案”。

![](https://totoro.ink/img/write/TvVr.jpg)
...
![](
https://totoro.ink/img/write/TNRh.jpg)
...
![有一种文案，只是自己的A片](https://totoro.ink/img/write/TPNl.jpg)
首先，出一个小问题：当你设计一款电灯泡的时候，你会怎么设计呢？

![有一种文案，只是自己的A片](https://totoro.ink/img/write/Tw5Y.jpg)
...
![有一种文案，只是自己的A片](https://totoro.ink/img/write/TiE3.jpg)

同样，到了文案也是这样。我认为：

 **文案是关于用户感受的设计，而不是创造这些感受的文字的设计。**

![有一种文案，只是自己的A片](https://totoro.ink/img/write/TtCJ.jpg)
...
![有一种文案，只是自己的A片](https://totoro.ink/img/write/Txhp.jpg)
...
![有一种文案，只是自己的A片](
https://totoro.ink/img/write/T3ji.jpg)
...
![有一种文案，只是自己的A片](https://totoro.ink/img/write/T7Zo.jpg)

再比如另一个经典文案——为了让一无所知的用户感受到第一代 iPod 的轻薄小巧和大容量，乔布斯说：

把 1000 首歌装到口袋里。

![有一种文案，只是自己的A片](https://totoro.ink/img/write/T8xX.jpg)

而反观 X 型文案人呢？他们才不关心用户是否能形成清晰的感受，他们注重的是发挥自己的创意和文字功底，所以你看到了这些文案：

![有一种文案，只是自己的A片](https://totoro.ink/img/write/TLVN.jpg)
...
![有一种文案，只是自己的A片](https://totoro.ink/img/write/Tsou.jpg)
...
![有一种文案，只是自己的A片](https://totoro.ink/img/write/TgCk.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/T5sW.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/TSnn.jpg)
...
[![有一种文案，只是自己的A片](
https://totoro.ink/img/write/TXZ8.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/Tm1Z.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/T4p6.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/Tpox.jpg)
...
![有一种文案，只是自己的A片](
https://totoro.ink/img/write/TzPB.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/Y654.jpg)

而很多文案的错误就在于不了解用户的 A 点，脑子中只想着自己要达到的 B 点。

比如下面这个文案，你觉得有什么问题？

[![有一种文案，只是自己的A片](https://totoro.ink/img/write/YYUw.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/YjFQ.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/YnsO.jpg)
...
![有一种文案，只是自己的A片](https://totoro.ink/img/write/Yrnv.jpg)
**假设一个现实生活中的情景**
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/YyeU.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/Y91M.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/YEpC.jpg)

然后你觉得在文案刚推出时的 2014 年的中国，用户真正的 A 点是什么呢？

我觉得用户真正的 A 点并不是“想喝好水，但是不知道哪家水比较好”，而是 **“没有觉得喝好水是重要的”**。

[![有一种文案，只是自己的A片](https://totoro.ink/img/write/Ya2r.jpg)

所以对于这样的用户 A 点，可能更合适的文案思路是告诉用户：

[![有一种文案，只是自己的A片](https://totoro.ink/img/write/YuPh.jpg)

再比如滴滴专车在 2014 年底的文案：

[![有一种文案，只是自己的A片](https://totoro.ink/img/write/YDOl.jpg)
...
[![有一种文案，只是自己的A片](https://totoro.ink/img/write/YRaY.jpg)

**而优秀的 Y 型文案是对用户感受的设计，而不是创造这些感受的文字的设计。** 它一定是从用户的 A 点出发的，是视觉化的、直指利益的并且让用户付出简单的行动。

[![有一种文案，只是自己的A片](https://totoro.ink/img/write/YoF3.jpg)