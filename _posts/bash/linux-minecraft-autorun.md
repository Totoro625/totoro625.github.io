...
输入
`java -version`
![](https://img.totoro.pub/images/2017/06/23/TQhn.png)
![](https://img.totoro.pub/images/2017/06/23/ToY8.png)
...
![](https://img.totoro.pub/images/2017/06/23/TDdW.png)
...
`cd kencery/`
c.然后使用Xftp将jdk复制到kencery文件夹下面，如图所示：![](https://img.totoro.pub/images/2017/06/23/T2KZ.png)将上传的jdk解压，解压之后重命名为javajdk，如图所示：
 `tar -zxv -f  jdk-8u65-linux-i586.gz`
 `mv jdk1.8.0_65  javajdk`
`cd javajdk`![](https://img.totoro.pub/images/2017/06/23/TBx6.png)
...
```
![](https://img.totoro.pub/images/2017/06/23/TI4x.png)
...
选择JDK*.rpm![](https://img.totoro.pub/images/2017/06/23/TZ04.png)
...
访问[downloads/spigot](https://yivesmirror.com/downloads/spigot)选择喜欢的版本进行下载![](https://img.totoro.pub/images/2017/06/23/TKRB.png)
...
![](https://img.totoro.pub/images/2017/06/23/Tegw.png)
